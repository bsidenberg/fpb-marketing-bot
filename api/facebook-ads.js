...
//   • fetchMetaAdsData extracted as a named export so api/analyze-ads.js
...
/**
 * Fetch Meta Ads campaign performance data for the given account.
 ...
 */
export async function fetchMetaAdsData(account, connection) {
...
export default async function handler(req, res) {
  ...
  try {
    const result = await fetchMetaAdsData(account, connection);
